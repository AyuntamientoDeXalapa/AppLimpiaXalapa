...
{
    /// <summary>
    /// Represent the push pin on the map control.
    /// </summary>
    public class MapExPushPin : ContentControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MapExPushPin"/> class.
        /// </summary>
        /// <param name="pin">The map pin to show.</param>
        internal MapExPushPin(MapExPin pin)
        {
            if (pin == null)
            {
        ...
        {
            var key = $"{this.Pin.Type}PushPinTemplate";
        ...
        {
            var anchor = new Windows.Foundation.Point(0.5, 0.5);
            var location =
                new Geopoint(
